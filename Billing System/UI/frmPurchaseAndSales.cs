...
namespace BillingSystem.UI
{
    public partial class frmPurchaseAndSales : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            name[cur] = txtProductName.Text;
            price[cur] = Total;
            dat[cur] = dtpBillDate.Value.ToString();
            cur++;
        ...
        private void Database_Add_items(int i)
        {
           // string sql = "SELECT * FROM tbl_transactions where transaction_date between '" + dateTimePicker1.Value.ToString("MM/dd/yyyy") + "' and '" + dateTimePicker2.Value.ToString("MM/dd/yyyy") + "'";
            SqlConnection con = new SqlConnection(myconnstrng);
            con.Open();
            string query = "insert into tbl_show(p_name , price , date) values(@nam , @pri ,@dat)";

            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.Add("@nam",SqlDbType.VarChar,100);
            cmd.Parameters.Add("@pri", SqlDbType.Decimal);
            cmd.Parameters.Add("@dat", SqlDbType.Date);

            cmd.Parameters["@nam"].Value = name[i];
            cmd.Parameters["@pri"].Value = price[i];
            cmd.Parameters["@dat"].Value = dat[i];
            cmd.ExecuteNonQuery();
            con.Close();
        }
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            using (TransactionScope scope = new TransactionScope())
            {
                ...
                if (success == true)
                {
                    ...
                    printer.Title = "\r\n\r\n\r\n Supershop Management And Billing System \r\n\r\n";
                    printer.SubTitle = "Dhaka, Mirpur \r\n Phone: 01788790001 \r\n\r\n";

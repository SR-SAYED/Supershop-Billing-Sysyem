...
namespace BillingSystem.DAL
{
    class transactionDAL
    {
        ...
        #endregion
       /* #region METHOD TO DISPLAY TRANSACTION BASED ON Date
                public DataTime loadData(string type)
        {
            //Create SQL Connection
            SqlConnection conn = new SqlConnection(myconnstrng);
            ...
            {
                //Write SQL Query
               //string sql = "SELECT * FROM tblpayroll WHERE DATE(PayrollDate) BETWEEN '" + from.ToString("yyyy-MM-dd") + "' AND '" + to.ToString("yyyy-MM-dd") + "'";
